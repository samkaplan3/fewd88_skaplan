...
document.getElementById('color-button').onclick = function(){changeColor("red")}

function changeColor (div1,div2,div3) {
  console.log("inside changeColor", div1)
	var red = document.getElementById(div1).value;
